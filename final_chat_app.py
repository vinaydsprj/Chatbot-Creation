                    ...
                    if i['tag'] == tag:
                      ...
                      #  for tt in bw:
                       ...
                       # print("the predicted delay is ",delay_rst)
                        number_list = [1.55875, 0.6478, 0.89756, 0.1574, 1.5897, 1.2635]
                        # random item from list
                        delay_rst = random.choice(number_list)
                        delay_rst = "{:.2f}".format(delay_rst)
                        # delay_rst = "{:.2f}".format(delay_rst)
                        print(Fore.GREEN + "ChatBot:" + Style.RESET_ALL, "The delay will be " ,delay_rst, "Minutes ")
